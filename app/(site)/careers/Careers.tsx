        ...
        <div className="text-left space-y-6 text-gray-700 dark:text-gray-300 mb-10">
          <div>
            ...
            <p>
              ...
              make informed health decisions, regardless of distance or medical
              complexity. Our mission goes beyond building another health app –
              we're creating a movement that revolutionizes how families care
              for each other across generations.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              transforms scattered health information into actionable insights,
              turning overwhelming into empowering.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              code, every design, and every solution directly impacts lives. We
              see beyond the tech—to the people it serves.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>The opportunity to shape the future of family healthcare</li>
            </ul>
          </div>
