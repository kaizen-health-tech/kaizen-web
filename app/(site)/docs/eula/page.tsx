            ...
            <div className="w-full px-4 lg:w-3/4">
              <div className="blog-details blog-details-docs shadow-three dark:bg-gray-dark rounded-sm bg-white px-8 py-11 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  Family mobile application ("App"), you agree to be bound by
                  this End User License Agreement ("Agreement") between you and
                  Kaizen Healthcare Inc ("Company," "we," "us," or "our"),
                  located at 1875 Mission St Ste 103 San Francisco, CA 94103. If
                  you do not agree to these terms, do not download, install, or
                  use the App.
                </p>
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  App, you represent and warrant that you are at least 18 years
                  of age and have the legal capacity to enter into this
                  Agreement.
                </p>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  <li>
                    Subscription fees are billed through your Apple App Store or
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  <li>
                    The App complies with the Health Insurance Portability and
                    Accountability Act (HIPAA)
                  </li>
                  <li>
                    You acknowledge that any health information you provide is
                    voluntary
                  </li>
                  <li>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  <li>
                    The AI chatbot feature ("Health Chatbot") provides general
                    health information and suggestions only
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    it because of information provided by the Health Chatbot
                  </li>
                  <li>
                    Users can report inappropriate or concerning AI responses
                    through the app's reporting feature
                  </li>
                  <li>
                    The Company does not guarantee the accuracy, completeness,
                    or usefulness of any AI-generated content
                  </li>
                </ul>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  <li>
                    ...
                    share your content for the purpose of providing our services
                  </li>
                  <li>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  <li>
                    You remain bound by sections that by their nature continue
                    after termination
                  </li>
                </ul>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  <li>
                    For users in India, additional terms may apply as required
                    by local law
                  </li>
                  <li>
                ...
                <ul className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  <li>
                    We will notify you of any material changes through the App
                    or via email
                  </li>
                  <li>
