            ...
            <div className="w-full px-4 lg:w-3/4">
              <div
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  This Privacy Policy Agreement ("Agreement") is entered into by
                  and between Kaizen Health ("Company"), and the user ("User")
                  of Company's Services. By accessing or using the Services,
                  User agrees to be bound by the privacy policy set forth in
                  this Agreement.
                </p>
                <p className="text-body-color dark:text-body-color-dark text-base">
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  protecting the privacy of our users ("user" or "you"). This
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  changes by updating the "Effective Date" of this Privacy
                ...
                <ul>
                  ...
                  <li>
                    ...
                    securely. This information may include, but is not limited
                    to, medical history, treatment plans, and health conditions.
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    other information regarding promotions and the App to you.
                  </li>
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  access, update, or delete your data at any time through the
                  app’s settings. If you choose to delete your account, all
                  associated data will be permanently removed from our servers.
                  Account deletion can be accessed via the following ways:
                </p>
                <ul>
                  <li>In-app via the profile settings. (Recommended method)</li>
                  <li>
                ...
                <h2>Use by Minors</h2>
                <p className="text-body-color dark:text-body-color-dark text-base">
                  The App is intended for use by individuals 18 years of age and
                  older. The App is not directed to individuals under the age of
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  Firebase (Google Inc), ensuring HIPAA compliance and secure
                ...
                <p className="text-body-color dark:text-body-color-dark text-base">
                  ...
                  <a href="mailto:info@kaizenhealth.io">this email address</a>.
                </p>
              </div>
            </div>
          </div>
