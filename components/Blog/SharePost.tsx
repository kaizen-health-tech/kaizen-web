const SharePost = ({ url, text, hashtags }) => {
  // Encode components to make them URL-safe
  ...
  const twitterShareUrl = `https://x.com/share?text=${encodedText}&url=${encodedUrl}&hashtags=${encodedHashtags}`;
