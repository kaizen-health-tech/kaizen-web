  ...
  <div className="relative mx-auto aspect-[6/5] w-full max-w-[420px]">
    ...
    <div className="absolute inset-0 flex items-center justify-center">
      <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-xl ring-1 ring-black/5">
        <MagnifyingGlassIcon className="h-9 w-9 text-violet" strokeWidth={1.75} />
      </div>
    </div>
...
export const OrganizedMockup = () => (
  <div className="mx-auto w-full max-w-[420px]">
    <div className="relative aspect-[6/5] w-full">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative flex h-36 w-36 items-center justify-center rounded-full bg-gradient-to-br from-violet to-dark-plum shadow-2xl">
          <FolderIcon className="h-14 w-14 text-white/90" strokeWidth={1.5} />
          <HeartIcon
...
const InsightRow = ({
  ...
  >
    <CheckCircleIcon className="mt-0.5 h-5 w-5 shrink-0 text-aquamarine" />
    <div>
      <p className="text-sm font-semibold text-[#1C1824]">{title}</p>
      <p className="text-xs text-[#8B879A]">{subtitle}</p>
    </div>
  </div>
);
...
export const ClearMockup = () => (
  <div className="mx-auto w-full max-w-[420px] overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5">
    <div className="flex items-center gap-3 border-b border-cloud p-4">
      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet to-[#8A6FE8]">
    ...
    <div className="space-y-4 p-4">
      <div className="flex justify-end">
        <div className="max-w-[85%] rounded-2xl rounded-tr-sm bg-violet/10 px-4 py-2.5 text-sm font-medium text-[#2B2436]">
          What should we review before Dad’s visit?
        </div>
      </div>

      <div className="rounded-xl bg-lavender/70 p-4">
        <div className="mb-1 flex items-center gap-1.5 text-xs font-bold tracking-wide text-violet">
...
export const ConnectedMockup = () => (
  <div className="mx-auto w-full max-w-[420px] rounded-3xl bg-white p-6 shadow-2xl ring-1 ring-black/5">
    <p className="mb-2 text-sm font-semibold text-[#1C1824]">Dad’s care circle</p>
    ...
    <div className="relative h-[290px]">
      ...
      <div
        className="absolute flex w-[86%] items-center gap-3 rounded-xl bg-[#201839] px-4 py-3 shadow-xl"
...
const ChecklistRow = ({
  ...
  <div
    className={`flex items-center gap-3 p-4 ${last ? "" : "border-b border-cloud"}`}
  >
...
export const PreparedMockup = () => (
  <div className="mx-auto w-full max-w-[420px] overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5">
    <div className="flex items-center gap-3 border-b border-cloud p-5">
      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-violet to-dark-plum">
